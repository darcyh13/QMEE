...
#there is significant differences in the L3 vein length between Egfr.rho and wt.rho genotypes in SAM but not ORE. 
#Egfr may act as enhancer of rho in SAM but does not have same interaction in ORE

#I want to see if there is background differences for these genotypes 
#
