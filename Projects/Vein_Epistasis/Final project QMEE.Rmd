...
After preforming these 4 approaches it does looks like the magnitude of genetic interactions does change in a background dependent manner. Although these approaches did give different results, it seems that there is a change in magnitude of the epistatic interactions between ORE and SAM in females for some veins and for some genetic combinations. 
